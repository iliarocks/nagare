...
nonisolated enum RecurrenceMode: String, CaseIterable, Codable, Sendable {
    case relative
    case absolute
}

nonisolated enum RecurrenceUnit: String, CaseIterable, Codable, Sendable {
    case day
    case week
    case month
    case year
...
nonisolated struct RecurrenceRule: Equatable, Sendable {
...
nonisolated enum RecurrenceCalculator {
...
nonisolated enum RecurrenceError: Error, Equatable, LocalizedError {
